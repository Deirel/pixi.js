...
export default class SpriteRenderer extends ObjectRenderer
{
    ...
    constructor(renderer)
    {
         ...
         * aVertexPosition(2), aTextureCoord(1), aColor(1), aOffset(1), aTextureId(1) = 6
         *
         * @member {number}
         */
        this.vertSize = 6;
    ...
    onContextChange()
    {
        ...
        for (let i = 0; i < this.vaoMax; i++)
        {
            ...
            const vao = this.renderer.createVao()
                ...
                .addAttribute(vertexBuffer, attrs.aOffset, gl.UNSIGNED_BYTE, true, this.vertByteSize, 4 * 4);
